...
<!--header -->
	<header>
		<div class="wrapper">
			...
			<span id="slogan">Cepat, Pasti Melayani  &amp; Yang Terbaik</span>
			<nav id="top_nav">
				<ul>
	...
	</header><div class="ic">More assetssite Templates at TemplateMonster.com!</div>
<!-- / header -->
<!--content -->
	<section id="content">
		...
		<div class="wrapper pad1">
					...
					<article class="col2">
						...
						<div class="wrapper">
							<article class="cols">
								...
								<p class="pad_bot1"><strong>Airlines is one of <a href="http://blog.templatemonster.com/free-assetssite-templates/" target="_blank">free assetssite templates</a> created by TemplateMonster.com team.</strong></p>
								<p>This assetssite template is optimized for 1024X768 screen resolution. It is also XHTML &amp; CSS valid. This assetssite template has several pages: <a href="index.html">About</a>, <a href="Offers.html">Offers</a>, <a href="Book.html">Book</a>, <a href="Services.html">Services</a>, <a href="Safety.html">Safety</a>, <a href="Contacts.html">Contacts</a>.</p>
							</article>
							<article class="cols pad_left1">
								<figure><img src="images/page1_img2.jpg" alt="" class="pad_bot2"></figure>
								<p class="pad_bot1"><strong>This <a href="http://blog.templatemonster.com/2011/05/09/free-assetssite-template-airlines/" target="_blank">Airlines Template</a> goes with two packages.</strong></p>
			...
			<footer>
				<div class="wrapper">
					...
					<div class="links">
						<a rel="nofollow" href="http://www.templatemonster.com/" target="_blank">assetssite template</a> designed by TemplateMonster.com<br>
