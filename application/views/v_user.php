      ...
      <div class="row">
        <div class="col-md-4">
          ...
          <div class="box box-primary">
            ...
            <div class="box-body">
              <form action="<?php echo base_url('admin/proses_tambah_user'); ?>" method="post">
<!--                 <div class="form-group">
                ...
                <div class="input-group date">
                  ...
                  <input type="text" class="form-control pull-right" id="datepicker" name="Username" required="true" readonly="true">
                  </div>
                </div> -->
                 <div class="form-group">
                  <label>Id :</label>
            ...
            <div class="box-body no-padding">
              <table class="table">
                ...
                <tr>
                  ...
                  <td><a style="cursor: pointer;" title="" onclick="href='<?php echo base_url(('admin/hapus_user/'.$s->id)); ?>'">Remove</a>  
                    <a style="cursor: pointer;" title="" onclick="href='<?php echo base_url(('admin/edit_user/'.$s->id)); ?>'">Edit</a>
                  </td>
                </tr>
                <?php } ?>
              </table>
