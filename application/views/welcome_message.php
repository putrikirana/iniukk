...
<head>
  <title>About</title>
<meta charset="utf-8">
<link rel="stylesheet" href="http://localhost/iniukk/gudang/frontend/css/reset.css" type="text/css" media="all">
<link rel="stylesheet" href="http://localhost/iniukk/gudang/frontend/css/layout.css" type="text/css" media="all">
<link rel="stylesheet" href="http://localhost/iniukk/gudang/frontend/css/style.css" type="text/css" media="all">
<script type="text/javascript" src="http://localhost/iniukk/gudang/frontend/js/jquery-1.5.2.js" ></script>
<script type="text/javascript" src="http://localhost/iniukk/gudang/frontend/js/cufon-yui.js"></script>
<script type="text/javascript" src="http://localhost/iniukk/gudang/frontend/js/cufon-replace.js"></script>  
<script type="text/javascript" src="http://localhost/iniukk/gudang/frontend/js/Cabin_400.font.js"></script>
<script type="text/javascript" src="http://localhost/iniukk/gudang/frontend/js/tabs.js"></script> 
<script type="text/javascript" src="http://localhost/iniukk/gudang/frontend/js/jquery.jqtransform.js" ></script>
<script type="text/javascript" src="http://localhost/iniukk/gudang/frontend/js/jquery.nivo.slider.pack.js"></script>
<script type="text/javascript" src="http://localhost/iniukk/gudang/frontend/js/atooltip.jquery.js"></script>
<script type="text/javascript" src="http://localhost/iniukk/gudang/frontend/js/script.js"></script>
<!--[if lt IE 9]>
